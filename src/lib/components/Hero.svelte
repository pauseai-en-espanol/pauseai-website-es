...
<div class="hero">
	...
	<section class="slogan">
		...
		<div class="slogan-inner">
			<h1>Súmate al movimiento para <em>Pausar</em> la IA.</h1>
			<div class="hero-buttons">
				<Link href="/inscripcion" class="btn-primary">Únete</Link>
				<Link href="/donate" class="btn-on-photo">Dona</Link>
			</div>
		</div>
	</section>

	<!-- CAMPAÑA — la campaña activa, sobre una banda clara para que se lea distinta y actual. -->
	<section class="campaign">
		<div class="campaign-inner">
			<span class="campaign-eyebrow">Campaña actual</span>
			<h2>La IA no viene <em>solo</em> por tu trabajo.</h2>
...
<style>
	...
	/* Velo oscuro sobre la foto. Más fuerte arriba-izquierda, donde va el titular;
	   más ligero a la derecha para que se vean la multitud y la pancarta de PAUSE AI. */
	.slogan-scrim {
		position: absolute;
		inset: 0;
		background:
	...
	/* CTA secundario sobre la foto — blanco sólido se lee bien sobre el velo oscuro. */
